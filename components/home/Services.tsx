    ...
    <section id="layanan" className="relative w-full bg-white py-10 md:py-20 font-sans overflow-hidden">
      <div className="max-w-[1380px] mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col items-center text-center max-w-[1000px] mx-auto mb-16 md:mb-24">
          ...
          <a href="https://wa.me/62881022376684?text=Halo%20NusaEducation%2C%20saya%20tertarik%20dengan%20layanan%20Anda%20dan%20ingin%20menjadwalkan%20konsultasi%20awal%20secara%20gratis." target="_blank" rel="noopener noreferrer" className="conversion [&>*]:pointer-events-none mt-8 bg-[#0A192F] text-white px-8 py-3.5 font-semibold text-[16px] hover:bg-[#112a4f] transition-colors tracking-wide inline-block">
