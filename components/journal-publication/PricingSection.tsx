            ...
            <div key={idx} className="bg-white border border-[#0A192F]/5 flex flex-col pointer-events-auto p-6 lg:p-8">
              ...
              <div className="flex flex-row items-center justify-between mb-5 gap-3">
                ...
                <div className="h-10 lg:h-14 flex shrink-0 items-center justify-end relative">
                  <Image src={pkg.logo} alt="Journal Logo" width={130} height={56} className="h-full w-auto object-contain max-w-[110px] xl:max-w-[130px]" />
                </div>
              </div>
              ...
              {/* CTA Button */}
              <a 
                href={`https://wa.me/62881022376684?text=${encodeURIComponent(`Halo NusaEducation, saya tertarik dengan paket pendampingan jurnal: ${pkg.name}. Bisakah kita berdiskusi lebih lanjut?`)}`}
